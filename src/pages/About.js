  ...
  return (
    <div className="about-container">
      ...
      <div className="learn-section">
        ...
        <ul className="list">
          <li><a className="learn-link" href="https://www.w3.org/WAI/fundamentals/" target="_blank">Accessibility Fundamentals Overview</a></li>
          <li><a className="learn-link" href="https://www.w3.org/WAI/standards-guidelines/wcag/" target="_blank">Web Content Accessibility Guidelines (WCAG) 2 Overview</a></li>
          <li><a className="learn-link" href="https://www.nngroup.com/articles/accessibility-inclusivity-study-guide/" target="_blank">Accessibility and Inclusivity: Study Guide | Nielsen Norman Group</a></li>
        </ul>
      </div>
